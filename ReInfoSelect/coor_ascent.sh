java -cp utils/RankLib-2.1-patched.jar ciir.umass.edu.features.FeatureManager -input ../features/cknrm_features -output ../features/ -k 2
...
python utils/gen_trec.py -dev ../data/dev_toy.tsv -res ../results/cknrm_ca.trec -k 2
rm f1.score
rm f2.score
